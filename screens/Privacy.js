  ...
  render() {
    return (
      <Block flex>
        ...
        >
          <Text style={{ fontFamily: 'montserrat-bold' }} size={16} color={nowTheme.COLORS.HEADER}>
        ...
        <Block flex row space="between" style={styles.buttonsWrapper}>
          ...
          >
            <Text style={{ fontFamily: 'montserrat-regular' }} size={12} color={nowTheme.COLORS.WHITE}>
              ACCEPT
            </Text>
          </Button>
          <Button
            ...
            style={styles.privacyButton}
          >
            <Text style={{ fontFamily: 'montserrat-regular' }} size={12} color={nowTheme.COLORS.MUTED}>
              DECLINE
            </Text>
          </Button>
        </Block>
